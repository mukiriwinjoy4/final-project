...
export default {
  data: () => ({
    ...
    links: [
      ...
      { icon: "mdi-phone", text: "ContactUs", route: "/contactus" },
      { icon: "mdi-menu", text: "Menu", route: "/menu" },
      { icon: "mdi-cart", text: "HowtoOrder", route: "/howtoorder" },
    ],
  }),
};
</script>
