<template>
    <v-main>
      <div class="pixie-oranges">
      <div class="pixie-oranges-image">
        <img src="./../assets/images/pixie-oranges.jpg" alt="Pixie Oranges" style="max-width: 400px;">
      </div>
      <div class="pixie-oranges-info">
        <h2>Pixie Oranges</h2>
