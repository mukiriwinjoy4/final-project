 <template>
  <v-main>
    <div class="apple-mangoes">
      <div class="apple-mangoes-image">
        <img src="./../assets/images/Apple-Mangoes.jpg" alt="Apple Mangoes" style="max-width: 400px;">
      </div>
      <div class="apple-mangoes-info">
        <h2>Apple Mangoes</h2>
