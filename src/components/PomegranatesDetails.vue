<template>
    <v-main>
      <div class="pomegranates">
      <div class="pomegranates-image">
        <img src="./../assets/images/Pomegranates.jpg" alt="Pomegranates" style="max-width: 400px;">
      </div>
      <div class="pomegranates-info">
        <h2>Pomegranates</h2>
